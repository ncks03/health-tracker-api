...
# # Importeer je models en database configuratie
# from main import get_db
#
# db = get_db()
#
# # Zorg ervoor dat het configuratieobject beschikbaar is
# config = context.config
#
# # Configuratie van het logging systeem
# fileConfig(config.config_file_name)
#
# # Stel hier je metadata in
...
if not database_url:
    raise ValueError("The DB_URL environment variable is not set.") # Set the sqlalchemy.url in
